...
(() => {
    ...
    var t = function(t, e, n, i) {
        return new(n || (n = Promise))((function(s, a) {
            function r(t) { try { d(i.next(t)) } catch (t) { a(t) } }

            function o(t) { try { d(i.throw(t)) } catch (t) { a(t) } }
    ...
    class s {
        ...
        tearDown() { this.reset(), this.input.removeEventListener("blur", this.inputBlurHandler), this.input.removeEventListener("input", this.inputInputHandler), this.input.removeEventListener("click", this.inputClickHandler) }
    }
    const a = t => !!["checkbox", "radio"].find((e => e === t.type)),
        r = (t, i) => {
            let s, r, c = !0;
            if (a(t) && (r = t.parentElement.parentElement), "object" == typeof i) { if (c = i.validate(), s = n(`[data-sb-feedback="${t.id}:${i.name}"]`), !s) throw new Error(`VALIDATION_NOT_SETUP_FOR: ${t.id}:${i.name}`) } else {
                switch (i) {
                    case "required":
                ...
                if (a(t)) try { s = n(`[data-sb-feedback="${t.name}:${i}"]`) } catch (e) { throw new Error(`VALIDATION_NOT_SETUP_FOR: ${t.name}:${i}`) } else try { s = n(`[data-sb-feedback="${t.id}:${i}"]`) } catch (e) { throw new Error(`VALIDATION_NOT_SETUP_FOR: ${t.id}:${i}`) }
            }
    ...
    })(), window.addEventListener("DOMContentLoaded", (() => { e("form[data-sb-form-api-token]").forEach((t => l(t))) }));
    ...
    const l = (r, o) => {
            ...
            E.forEach((t => {
                ...
                e ? (t.dataset.sbCanSubmit = "no", c.push(new s(t, (t => { const e = t.split(",").map((t => t.trim())); return e.forEach((t => { if (!(t in i)) throw new Error(`UNRECOGNIZED_VALIDATION_KEY: ${t}`) })), e })(e), l))) : t.dataset.sbCanSubmit = "yes"
            }));
            const y = e => {
                    return n = void 0, i = void 0, a = function*() {
                        ...
                        function r(t) { try { d(a.next(t)) } catch (t) { e(t) } }

                        function o(t) { try { d(a.throw(t)) } catch (t) { e(t) } }

                        function d(e) {
                            var n;
                            e.done ? t(e.value) : (n = e.value, n instanceof s ? n : new s((function(t) { t(n) }))).then(r, o)
                        }
            ...
            return c.forEach((t => t.initValidation())), w(), { tearDown: () => { m.removeEventListener("click", L), f.classList.add("d-none"), v.classList.add("d-none"), m.classList.remove("d-none"), m.classList.add("disabled"), E.forEach((t => { t.removeAttribute("disabled") })), c.forEach((t => t.tearDown())) } }
        },
        u = t => {
            const e = {};
            return t.forEach((t => {
